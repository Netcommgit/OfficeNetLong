...
namespace OfficeNet.Migrations
{
    ...
    [Migration("20250801130644_updatehelpdesks")]
    partial class updatehelpdesks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OfficeNet.Domain.Entities.HelpDeskDetail", b =>
                {
                    ...
                    b.Property<int?>("TentativeClosureDay")
                        .HasColumnType("int");

                    b.Property<int?>("TentativeClosureHour")
                        .HasColumnType("int");

                    b.HasKey("IssueID");

                    b.ToTable("HelpDeskDetails");
                });

            modelBuilder.Entity("OfficeNet.Domain.Entities.HelpdeskAdminUser", b =>
                {
                    b.Property<int>("HdeskAdminId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HdeskAdminId"));
                    ...
                    b.HasKey("HdeskAdminId");

                    b.HasIndex("AdminUserID");

                    b.HasIndex("IssueID");

                    b.ToTable("HelpdeskAdminUser");
                });
            ...
            modelBuilder.Entity("OfficeNet.Domain.Entities.HelpdeskAdminUser", b =>
                {
                    b.HasOne("OfficeNet.Domain.Entities.ApplicationUser", "AdminUser")
                        .WithMany()
